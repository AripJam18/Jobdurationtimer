...
Public Class Form1
    ...
    Sub TampilGrid()
        DA = New MysqlDataAdapter("SELECT * FROM jobdurationtimer WHERE timestamp >= '" & Format(DTPFrom.Value, "yyyy-MM-dd") & "' AND timestamp >= '" & Format(DTPFrom.Value, "yyyy-MM-dd") & "' ", CONN)
        ''LIMIT 10 
        DS = New DataSet
        DA.Fill(DS)
